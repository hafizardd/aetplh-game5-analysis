...
class OutputGenerator:
    ...
    def __init__(self, file_name=None, output_path=None):
    ...
    def __get_full_path(self, file_name: str) -> str:
        """Get the full file path including output_path if specified."""
        if self.output_path:
            return f'{self.output_path}/{file_name}'
        return file_name
    ...
    def __generate_clean_dataset(self, dataset):
        file_name = self.__get_full_path(self.output_name + ".txt")
        result_set = []
    ...
    def __generate_json_dataset(self, dataset):
        ...
        file_name = self.__get_full_path(self.output_name + ".json")
